...
- add figure/figcaption variations for image + caption patterns
- add object-fit variations for common aspect ratio handling patterns
- add responsive image utilities for generating srcset/sizes attributes from image metadata and breakpoints
