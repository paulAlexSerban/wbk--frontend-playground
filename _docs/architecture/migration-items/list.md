...
- **Source**: libraries/dev-days-matrix-library/src/library/components/list
- **Legacy meta**: n/a (source has SCSS entries only)
- **Target**: projects/components/list
...
- [x] src/\_partials/\_list.hbs — variation partial
- [x] src/styles.scss + split modules in src/styles/
- [x] src/scripts.js + src/scripts/index.js + src/scripts/\_list.js
...
- [x] yarn --cwd projects/components/list build -> webpack compiled successfully
...
- [x] Build validation passed (yarn --cwd projects/components/list build)
