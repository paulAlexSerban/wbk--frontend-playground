# Migration Checklist: audio

## Item Identification

- **Source**: libraries/dev-days-matrix-library/src/library/patterns/audio
- **Legacy meta**: libraries/dev-days-matrix-library/src/library/patterns/audio/meta.json
- **Target**: projects/components/audio
...
- [x] src/\_partials/\_audio.hbs — variation partial
- [x] src/styles.scss + split modules in src/styles/
- [x] src/scripts.js + src/scripts/index.js + src/scripts/\_audio.js
...
- [x] yarn --cwd projects/components/audio build -> webpack compiled successfully
...
- [x] Build validation passed (yarn --cwd projects/components/audio build)
