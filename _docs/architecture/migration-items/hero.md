# Migration Checklist: hero

## Item Identification

- **Source**: libraries/dev-days-matrix-library/src/library/patterns/hero
- **Legacy meta**: libraries/dev-days-matrix-library/src/library/patterns/hero/meta.json
- **Target**: projects/components/hero
...
- [x] src/\_partials/\_hero.hbs — variation partial
- [x] src/styles.scss + split modules in src/styles/
- [x] src/scripts.js + src/scripts/index.js + src/scripts/\_hero.js
...
- [x] yarn --cwd projects/components/hero build -> webpack compiled successfully
