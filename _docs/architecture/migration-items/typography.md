# Migration Checklist: typography

## Item Identification

- **Source**: libraries/dev-days-matrix-library/src/library/components/typography
- **Legacy meta**: libraries/dev-days-matrix-library/src/library/components/typography/meta.json
- **Target**: projects/components/typography
...
- [x] src/\_partials/\_typography.hbs — variation partial
- [x] src/styles.scss + split modules in src/styles/
- [x] src/scripts.js + src/scripts/index.js + src/scripts/\_typography.js
...
- [x] yarn --cwd projects/components/typography build -> webpack compiled successfully
