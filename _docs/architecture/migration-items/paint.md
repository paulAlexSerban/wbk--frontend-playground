...
- **Legacy meta**: libraries/dev-days-matrix-library/src/library/components/paint/meta.json
...
- [x] src/\_partials/\_paint.hbs — variation partial
- [x] src/styles.scss + split modules in src/styles/
- [x] src/scripts.js + src/scripts/index.js + src/scripts/\_paint.js
...
- [x] yarn --cwd projects/components/paint build -> webpack compiled successfully
...
- [x] Build validation passed (yarn --cwd projects/components/paint build)
