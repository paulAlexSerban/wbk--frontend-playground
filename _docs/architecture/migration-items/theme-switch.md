...
- **Legacy meta**: libraries/dev-days-matrix-library/src/library/patterns/theme-switch/meta.json
...
- [x] yarn --cwd projects/components/theme-switch build -> webpack compiled successfully
