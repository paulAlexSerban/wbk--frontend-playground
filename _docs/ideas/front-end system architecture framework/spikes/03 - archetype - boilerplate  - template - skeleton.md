...
> A template is a _starting shape_, not a full system.
...
A **boilerplate** is a _working base project_ with repetitive setup already done.
...
> Boilerplate is about _saving time on known, repetitive code_.
...
A **skeleton** is the _minimal structural foundation_ of a system.
...
> A skeleton defines _how things are organized_, not how they work.
...
An **archetype** is a _code generator blueprint_.
...
> Archetype = _factory for templates/boilerplates_
