...
async function resolveDashboardCatalogPaths({ projectRoot, catalogSegment = 'projects' }) {
    ...
    const sourceDir = path.join(packageRoot, repositoryDirectory, catalogSegment);
