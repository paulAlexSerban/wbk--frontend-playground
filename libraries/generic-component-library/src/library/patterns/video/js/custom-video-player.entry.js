...
(() => {
    ...
    const VideoPlayer = (el) => {
        const global = { state: {}, elements: {}, sources: {} };
        ...
        const updatePlayIcon = () => {
            if (global.elements.video.paused) {
                global.elements.play.innerHTML = `<img class="fa-play" src=${global.sources.playSvg} />`;
            } else {
                global.elements.play.innerHTML = `<img class="fa-stop" src=${global.sources.stopSvg} />`;
            }
        };
